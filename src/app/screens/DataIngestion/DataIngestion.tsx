...
export default function DataIngestion() {
  ...
  const [selectedSourceId, setSelectedSourceId] = useState<string>(mockProjects[0].sources[0].id);
  ...
  const handleProjectChange = (projectId: string) => {
    ...
    setSelectedSourceId(nextProject.sources[0]?.id || '');
    setSearchQuery('');
  };
            ...
            <div className="flex items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                <select
                    ...
                    className="min-w-56 px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                >
