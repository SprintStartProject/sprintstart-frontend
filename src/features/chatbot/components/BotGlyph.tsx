...
export function BotGlyph({
  ...
  const eyeAnimation = isWaking
    ...
    : isAwed
      ...
      : {
          ...
          ...(thinking ? EYE_DRIFT : dizzy ? EYE_ROLL : isTracking ? {} : { x: 0, y: 0 }),
        };
  ...
  return (
    ...
    >
      ...
      >
        <path d="M12 4.2V2.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <motion.circle
          cx="12"
          cy="1.6"
          r="1.25"
          ...
          transition={
            thinking ? { duration: 1.1, repeat: Infinity, ease: "easeInOut" } : { duration: 0.5 }
          }
        />
      </motion.g>
