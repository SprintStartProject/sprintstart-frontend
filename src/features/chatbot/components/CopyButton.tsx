...
export function CopyButton({ text }: CopyButtonProps) {
    ...
    return (
        <button
            ...
            className="flex items-center gap-1 text-[11px] text-app-text-subtle transition-colors hover:text-app-text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus rounded-md px-1 py-0.5"
        >
