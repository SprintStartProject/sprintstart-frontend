    ...
    return (
        <section className="relative overflow-hidden rounded-2xl border border-app-border bg-app-surface px-6 py-8 sm:px-8 sm:py-10">
            ...
            <motion.div
                ...
                className="pointer-events-none absolute -right-20 -top-24 h-72 w-72 rounded-full bg-app-brand/25 blur-3xl"
            />
            ...
            <div className="relative flex flex-wrap items-center justify-between gap-6">
                ...
                <p className="text-4xl font-light tabular-nums text-app-text/80 sm:text-5xl">
                    {formattedTime}
                </p>
            </div>
        </section>
