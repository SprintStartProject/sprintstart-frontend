  ...
  return (
    <div className="min-h-[420px] bg-app-bg p-8">
      <p className="max-w-sm text-sm text-app-text-muted">
        Bottom-right corner. It hides there and leans out every so often — move the pointer near it
        to bring it fully out, click it to launch it. It stays gone for a few minutes before it
        comes back. On a touchscreen the first tap brings it out and the second one launches it;
        switch the toolbar to a mobile device to try that.
      </p>
      <RocketPet />
    </div>
  );
