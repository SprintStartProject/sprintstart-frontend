 ...
 */
export function MomentCelebration({ celebration, onDismiss }: MomentCelebrationProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-app-overlay p-6 backdrop-blur-md">
      ...
      <motion.div
        ...
        initial={reduceMotion ? { opacity: 0 } : { opacity: 0, scale: 0.86, y: 18 }}
      ...
      >
        ...
        {celebration.progress ? (
          ...
          <motion.div
            ...
            transition={reduceMotion ? { duration: 0 } : { ...celebrationSpringToken, delay: 0.06 }}
        ...
        <h2 id="moment-title" className="relative text-2xl font-bold tracking-tight text-app-text">
          {celebration.title}
        </h2>
