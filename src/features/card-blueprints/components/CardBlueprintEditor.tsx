  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <fieldset className="space-y-2">
          <legend className="text-sm font-medium text-app-text">Which roles get this</legend>
          <p className="text-xs text-app-text-muted">
            Tick none to give it to everybody on the project.
          </p>
              ...
              {roles.map((role) => (
                <li key={role.id} className="flex items-center gap-2.5">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {role.description && (
                      <span className="block text-xs text-app-text-muted">{role.description}</span>
                    )}
                  </span>
                </li>
              ))}
