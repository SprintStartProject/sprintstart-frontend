      ...
      <div>
        <div className="mb-1 flex items-center justify-between gap-2">
          <div className="flex min-w-0 items-center gap-1">
            ...
            <h3 className="truncate text-sm font-semibold text-app-text">Role Management</h3>
          </div>
              ...
              >
                ...
                {isExpanded && !isAssigning && (
                  <div className="border-t border-app-border px-3 py-2.5">
                    {role.description && (
                      <p className="mb-2 text-xs text-app-text-muted">{role.description}</p>
                    )}

                    <div className="flex flex-wrap gap-1.5">
                      {roleSkills.map((skill) => (
                        <Badge key={skill.id} variant="neutral" className="px-2.5 py-1">
                          {skill.name}
                        </Badge>
                      ))}
