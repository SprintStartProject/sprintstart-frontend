...
export function ProjectRolesModal({ open, onClose }: ProjectRolesModalProps) {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      const [rolesData, skillsData] = await Promise.all([getProjectRoles(), getSkills()]);
    ...
    <>
      ...
      >
        <div className="border-t border-app-border pt-6">
          <h3 className="mb-3 text-sm font-semibold text-app-text">Create New Role</h3>
          <p className="mb-3 text-xs leading-relaxed text-app-text-muted">
            Create a project role first. After that, select it below to add the skills people in
            this role should assess.
          </p>
          ...
          <div className="mt-6">
            <h3 className="mb-3 text-sm font-semibold text-app-text">Existing Roles</h3>
            <p className="mb-3 text-xs leading-relaxed text-app-text-muted">
            ...
            {selectedRole && (
              <div className="mt-5 rounded-2xl border border-app-border bg-app-bg p-4">
                <h3 className="text-sm font-semibold text-app-text">{selectedRole.name}</h3>
                ...
                <div className="mt-4">
                  <p className="mb-2 text-xs font-medium text-app-text-muted">Skills</p>
                  <p className="mb-3 text-xs leading-relaxed text-app-text-muted">
                    Add skills that belong to this role. These show up in the skill assessment flow
      ...
      <AlertDialog
        ...
        description={
          <>
            Are you sure you want to {deleteSkillId ? "retire" : "delete"}{" "}
