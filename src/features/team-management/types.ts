export type SkipRequestStatus = "PENDING" | "ACCEPTED" | "DENIED";
 ...
 * `TeamManagementPage` renders its tab bar in this order and derives the slide
 * direction from it, so the content always travels the same
...
export type TeamOverviewFilters = {
  roleId: string;
  sortBy: "LONGEST_STEP" | "SHORTEST_STEP" | "HIGHEST_PROGRESS" | "LOWEST_PROGRESS";
};
