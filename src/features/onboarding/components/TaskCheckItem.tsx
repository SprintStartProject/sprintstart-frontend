...
export function TaskCheckItem({
    ...
    return (
        <motion.button
            ...
            onClick={onToggle}
            aria-pressed={isDone}
            className={`flex w-full items-start gap-4 rounded-xl border p-4 text-left transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus ${
                isDone
        ...
        >
            <span className="relative mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center">
                ...
                <motion.span
                    ...
                    className={`flex h-5 w-5 items-center justify-center rounded-full border-2 ${
                        isDone
                            ? "border-app-success-solid bg-app-success-solid"
            ...
            <span className="min-w-0">
                ...
                >
                    ...
                    <motion.span
                        aria-hidden="true"
                        className="absolute left-0 top-1/2 h-px w-full origin-left bg-app-text-subtle"
                        initial={false}
