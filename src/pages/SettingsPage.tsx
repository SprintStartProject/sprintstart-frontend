        ...
        <div className="h-full min-h-screen w-full bg-app-bg">
            ...
            {dino.toast && (
                <div
                    role="status"
                    aria-live="polite"
                    className="pointer-events-none fixed bottom-8 left-1/2 z-50 -translate-x-1/2 animate-in fade-in slide-in-from-bottom-4 rounded-full bg-app-brand px-4 py-2 text-sm font-medium text-white shadow-2xl"
                >
                    {dino.toast}
                </div>
            )}
