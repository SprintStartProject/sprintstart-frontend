...
function getNavLinkClass(isActive: boolean): string {
    return [
        ...
        isActive
            ...
            : 'text-app-text-muted hover:bg-app-surface-hover hover:text-app-text [&>svg]:text-app-text-subtle hover:[&>svg]:text-app-text',
    ].join(' ');
}

function SidebarContent({ onNavigate, isDarkMode, onToggleTheme }: SidebarContentProps) {
            ...
            <div className="space-y-[12px] border-t border-app-border bg-app-surface p-[16px]">
                {profile && (
                    <div className="mb-4 flex items-center gap-3 px-3 py-2">
                        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-app-surface-muted text-app-text-subtle">
                        ...
                        <div className="flex flex-col overflow-hidden">
                            ...
                            <span className="truncate text-[10px] font-medium uppercase tracking-wider text-app-text-disabled">
                ...
                <button
                    ...
                    className="flex h-[40px] w-full items-center justify-between rounded-[8px] px-[12px] text-[14px] font-medium leading-none text-app-text-muted transition-colors hover:bg-app-surface-hover hover:text-app-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-focus"
                >
                    <span className="flex items-center gap-[12px]">
                        {isDarkMode ? (
                            <Moon className="h-[16px] w-[16px] text-app-text-subtle" />
                        ) : (
                            <Sun className="h-[16px] w-[16px] text-app-text-subtle" />
                        )}
                    ...
                    <span
                        className={[
                            'flex h-[16px] w-[32px] items-center rounded-full p-[4px] transition-colors',
                            isDarkMode
