            ...
            <div className="overflow-x-auto">
                <table className="w-full border-collapse text-left">
                    ...
                    <tr className="border-b border-app-border bg-app-surface-muted">
                        <th className="px-4 py-5 text-[11px] font-bold uppercase tracking-widest text-app-text-muted sm:px-6">
                            Document
                        </th>

                        <th className="px-4 py-5 text-center text-[11px] font-bold uppercase tracking-widest text-app-text-muted sm:px-6">
                            Status
                        </th>

                        <th className="hidden px-4 py-5 text-[11px] font-bold uppercase tracking-widest text-app-text-muted sm:px-6 md:table-cell">
                            Ingested At
                        </th>

                        <th className="px-4 py-5 text-right text-[11px] font-bold uppercase tracking-widest text-app-text-muted sm:px-6">
                            Actions
                        </th>
                    </tr>
                    </thead>
                            ...
                            >
                                <td className="px-4 py-4 sm:px-6">
                                    <div className="flex items-center gap-2 sm:gap-4">
                                        <div className="shrink-0 rounded-lg bg-app-surface-muted p-1.5 text-app-text-muted transition-colors group-hover:bg-app-brand-soft group-hover:text-app-brand-text sm:rounded-xl sm:p-2.5">
                                ...
                                <td className="hidden px-4 py-4 text-sm font-medium text-app-text-muted sm:px-6 md:table-cell">
                            ...
                            <td colSpan={4} className="px-6 py-20 text-center">
                                <div className="mx-auto flex max-w-sm flex-col items-center gap-4">
                                    <div className="rounded-full bg-app-surface-muted p-4">
                                        <FileCode className="h-10 w-10 text-app-text-muted" />
                                    </div>
