        ...
        <div className="w-full">
            ...
            >
                ...
                <div
                    className={[
                        ...
                        isDragActive
                            ...
                            : 'bg-app-surface-muted text-app-text-subtle group-hover:bg-app-brand-soft group-hover:text-app-brand-text',
                    ].join(' ')}
                >
                    {isUploading ? (
                ...
                <div className="space-y-1 text-center">
                    ...
                    <p className="px-4 text-xs text-app-text-subtle sm:text-sm">
