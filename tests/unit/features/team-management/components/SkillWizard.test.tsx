...
describe('SkillWizard', () => {
    ...
    it('renders the modal title and skill cards for role-linked skills', () => {
        render(
            <SkillWizard open={true} user={createUser()} skills={mockSkills} onClose={vi.fn()} onSubmit={vi.fn()} />,
        );
    ...
    it('calls onSubmit with the assessment payload when save is clicked', async () => {
        ...
        const onClose = vi.fn();
        render(
            <SkillWizard open={true} user={createUser()} skills={mockSkills} onClose={onClose} onSubmit={onSubmit} />,
        );
    ...
    it('shows "No skills found" message when no skills match the roles', () => {
        render(
            <SkillWizard open={true} user={createUser({ roles: [] })} skills={mockSkills} onClose={vi.fn()} onSubmit={vi.fn()} />,
        );
    ...
    it('calls onClose when the "Later" button is clicked', async () => {
        ...
        const onClose = vi.fn();
        render(
            <SkillWizard open={true} user={createUser()} skills={mockSkills} onClose={onClose} onSubmit={vi.fn()} />,
        );
