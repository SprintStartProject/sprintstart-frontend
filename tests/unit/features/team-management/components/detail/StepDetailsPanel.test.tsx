...
describe('StepDetailsPanel', () => {
    ...
    it('calls onTaskInsertTargetChange when "Add first task" is clicked', async () => {
        ...
        render(<StepDetailsPanel {...defaultProps} tasks={[]} doneTaskCount={0} onTaskInsertTargetChange={onTaskInsertTargetChange} />);
    ...
    it('shows feedback items when provided', () => {
        render(
            <StepDetailsPanel
                {...defaultProps}
                feedbackItems={[
                    { id: 'f1', stepId: 'step1', helpful: true, message: 'Great step!', read: true, createdAt: '2026-07-01T00:00:00Z' },
                ]}
            />,
        );
    ...
    it('shows unread badge for unread feedback', () => {
        render(
            <StepDetailsPanel
                {...defaultProps}
                feedbackItems={[
                    { id: 'f1', stepId: 'step1', helpful: false, message: 'Confusing', read: false, createdAt: '2026-07-01T00:00:00Z' },
                ]}
            />,
        );
