...
describe("BoardGrid", () => {
  ...
  it("claims the buddy added a card only when the buddy actually placed it", () => {
    ...
    rerender(<BoardGrid board={board([pullRequestContent()], "2026-07-27T09:00:00Z")} />);
  ...
  it("offers to remove a card, and says the buddy will not put it back", () => {
    ...
    render(<BoardGrid board={board([pullRequestContent()])} onDismiss={onDismiss} />);
  ...
  it("has no remove control when removing is not offered", () => {
    render(<BoardGrid board={board([pullRequestContent()])} />);
  ...
  it("says the task on the card is one the hire picked", () => {
    render(<BoardGrid board={board([currentTaskContent()])} />);
