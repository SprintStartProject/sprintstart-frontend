...
import type { OnboardingStepEndpoint, OnboardingTaskEndpoint } from '../../../src/features/onboarding/types';
...
const tasks: OnboardingTaskEndpoint[] = [
    { id: 't1', stepId: 's1', position: 0, title: 'Install Node.js', description: '', finished: false },
    { id: 't2', stepId: 's1', position: 1, title: 'Install dependencies', description: 'Run npm install', finished: true }
];
