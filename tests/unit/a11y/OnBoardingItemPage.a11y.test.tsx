...
vi.mock('../../../src/services/onboardingService', () => ({
    onboardingService: {
        ...
        fetchTasks: vi.fn().mockResolvedValue([
            { id: 't1', stepId: 'step1', position: 0, title: 'Install Node.js', description: '', finished: false }
        ]),
        fetchResources: vi.fn().mockResolvedValue([
            { id: 'res1', stepId: 'step1', title: 'Node.js download', description: '', url: 'https://nodejs.org' }
        ]),
        ...
        skipStep: vi.fn().mockResolvedValue({ id: 'skip1', stepId: 'step1', status: 'PENDING', reason: '', reviewComment: null, createdAt: '' }),
