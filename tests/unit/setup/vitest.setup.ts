...
// jsdom implements Range but not its layout methods, so anything that positions UI against a
// selection (the board's "add to board" toolbar) throws rather than returning a zero rect. A zero
