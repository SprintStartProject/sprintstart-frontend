...
describe('Button', () => {
    ...
    it('hides the leading icon behind the spinner while loading', () => {
        const { rerender } = render(
            <Button icon={<span data-testid="leading-icon" />}>Save</Button>,
        );
        expect(screen.getByTestId('leading-icon')).toBeInTheDocument();

        rerender(<Button loading icon={<span data-testid="leading-icon" />}>Save</Button>);
